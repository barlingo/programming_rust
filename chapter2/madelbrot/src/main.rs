...
fn main() {
    ...
    let upper_left = parse_complex(&args[3]).expect("Error parsing upper coner point");
...
/// Write buffer 'pixels', whose dimensions are given by 'bounds', to the file named 'filename'
fn write_image(
    filename: &str,
    pixels: &[u8],
    bounds: (usize, usize),
...
/// Render a rectangle of the Madelbrot set into a buffer of pixels
///
/// The 'bounds' arguments gives the width and height of the buffer 'pixels'
